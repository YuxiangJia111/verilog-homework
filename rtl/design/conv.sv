module conv #(
   ...
   assign pipe_en_in           = is_fst_fo_d0 ? in_valid : 1'b1;
    ...
    assign is_lst_kk_fi_d0      = (cntr_kk == KK - 1) && (cntr_fi == FOLD_I - 1) && pipe_en;
    ...
    assign line_buffer_we       = is_fst_fo_d0 && in_valid && pipe_en_out;
    ...
    assign in_buf_d1 = is_fst_fo_d1 ? in_data_d1 : line_buffer_rdata_d1;
